...
static void setup_mock_device(uint8_t bus, uint8_t device, uint8_t function, uint16_t vendor_id, uint16_t device_id,
                              uint8_t class_code, uint8_t subclass, uint8_t prog_if) {
    // Calculate device offset in ECAM space
    const uint64_t device_offset = ((uint64_t)bus << 20) | ((uint64_t)device << 15) | ((uint64_t)function << 12);
...
static MunitResult test_PCI_REG_UU_B(const MunitParameter params[], void *param) {
    uint32_t result;
...
static MunitResult test_PCI_REG_UM_B(const MunitParameter params[], void *param) {
    uint32_t result;
...
static MunitResult test_PCI_REG_LM_B(const MunitParameter params[], void *param) {
    uint32_t result;
...
static MunitResult test_PCI_REG_LL_B(const MunitParameter params[], void *param) {
    uint32_t result;
...
static MunitResult test_pci_config_read32_basic(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
    ...
    munit_assert_uint32(0x12348086, ==,
                        vendor_device); // Little endian: device_id << 16 | vendor_id

    return MUNIT_OK;
}

static MunitResult test_pci_config_read16_basic(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_config_read8_basic(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_config_read_no_device(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_config_read_out_of_bounds(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_config_read_null_driver(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_config_read_alignment(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
    ...
    uint16_t unaligned = pci_config_read16(&test_bus_driver, 0, 4, 0, 0x09); // Should read prog_if | subclass
...
static MunitResult test_pci_device_exists_true(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_device_exists_false(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_device_exists_invalid_vendor_ids(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_pci_device_exists_valid_vendor_ids(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_ahci_controller_detection(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
    ...
    const uint64_t device_offset = ((uint64_t)0 << 20) | ((uint64_t)14 << 15) | ((uint64_t)0 << 12);
    uint8_t *device_config = mock_ecam_space + device_offset;
...
static MunitResult test_multi_function_device_detection(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
    ...
    const uint64_t device_offset = ((uint64_t)0 << 20) | ((uint64_t)15 << 15) | ((uint64_t)0 << 12);
    uint8_t *device_config = mock_ecam_space + device_offset;
    *(uint8_t *)(device_config + 0x0E) = 0x80; // Multi-function header type
    ...
    munit_assert_false(pci_device_exists(&test_bus_driver, 0, 15, 3)); // No function 3
...
static MunitResult test_pci_bridge_detection(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
    ...
    const uint64_t device_offset = ((uint64_t)1 << 20) | ((uint64_t)0 << 15) | ((uint64_t)0 << 12);
    uint8_t *device_config = mock_ecam_space + device_offset;
    ...
    *(uint8_t *)(device_config + 0x19) = 0x02; // Secondary bus number = 2
    ...
    munit_assert_uint8(0x01, ==,
                       header_type & 0x7F); // Bridge type (ignore multi-function bit)
...
static MunitTest test_suite_tests[] = {
        ...
        {(char *)"/pci/PCI_REG_UU_B", test_PCI_REG_UU_B, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/PCI_REG_UM_B", test_PCI_REG_UM_B, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/PCI_REG_LM_B", test_PCI_REG_LM_B, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/PCI_REG_LL_B", test_PCI_REG_LL_B, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},

        // PCI configuration space access tests
        {(char *)"/pci/config_read32_basic", test_pci_config_read32_basic, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/config_read16_basic", test_pci_config_read16_basic, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/config_read8_basic", test_pci_config_read8_basic, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/config_read_no_device", test_pci_config_read_no_device, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
        {(char *)"/pci/config_read_out_of_bounds", test_pci_config_read_out_of_bounds, setup, NULL,
         MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/config_read_null_driver", test_pci_config_read_null_driver, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
        {(char *)"/pci/config_read_alignment", test_pci_config_read_alignment, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},

        // PCI device enumeration tests
        {(char *)"/pci/device_exists_true", test_pci_device_exists_true, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/device_exists_false", test_pci_device_exists_false, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/device_exists_invalid_vendor_ids", test_pci_device_exists_invalid_vendor_ids, setup, NULL,
         MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/pci/device_exists_valid_vendor_ids", test_pci_device_exists_valid_vendor_ids, setup, NULL,
         MUNIT_TEST_OPTION_NONE, NULL},

        // AHCI controller detection tests
        {(char *)"/pci/ahci_controller_detection", test_ahci_controller_detection, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},

        // Multi-function device tests
        {(char *)"/pci/multi_function_device_detection", test_multi_function_device_detection, setup, NULL,
         MUNIT_TEST_OPTION_NONE, NULL},

        // Bridge device tests
        {(char *)"/pci/bridge_detection", test_pci_bridge_detection, setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
