...
static MunitResult test_register_device_basic(const MunitParameter params[],
                                              void *data) {
    (void)params;
    (void)data;

    DeviceInfo device = {.device_id =
                                 0, // Should be assigned by register_device
                         .parent_id = 0,
    ...
    munit_assert_uint32(device_registry[0].device_type, ==,
                        DEVICE_TYPE_STORAGE);
...
static MunitResult test_register_device_multiple(const MunitParameter params[],
                                                 void *data) {
    (void)params;
    (void)data;
...
static MunitResult
test_register_device_max_capacity(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_register_device_null_info(const MunitParameter params[],
                                                  void *data) {
    (void)params;
    (void)data;
...
static MunitResult test_unregister_device_basic(const MunitParameter params[],
                                                void *data) {
    (void)params;
    (void)data;
...
static MunitResult
test_unregister_device_nonexistent(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;
...
static MunitResult
test_unregister_device_with_gaps(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;

    // Register three devices
    DeviceInfo device1 = {.device_type = DEVICE_TYPE_PCI, .name = "Device1"};
    DeviceInfo device2 = {.device_type = DEVICE_TYPE_STORAGE,
                          .name = "Device2"};
    DeviceInfo device3 = {.device_type = DEVICE_TYPE_DISPLAY,
                          .name = "Device3"};
...
static MunitResult test_query_devices_all(const MunitParameter params[],
                                          void *data) {
    (void)params;
    (void)data;
    ...
    DeviceInfo devices[] = {
            {.device_type = DEVICE_TYPE_PCI, .name = "PCI Device"},
    ...
    uint32_t count =
            query_devices(QUERY_ALL, DEVICE_TYPE_UNKNOWN, 0, results, 10);
...
static MunitResult test_query_devices_by_type(const MunitParameter params[],
                                              void *data) {
    (void)params;
    (void)data;
    ...
    DeviceInfo network = {.device_type = DEVICE_TYPE_NETWORK,
                          .name = "Ethernet"};
    ...
    DeviceInfo results[10];
    uint32_t count =
            query_devices(QUERY_BY_TYPE, DEVICE_TYPE_STORAGE, 0, results, 10);
...
static MunitResult test_query_devices_by_id(const MunitParameter params[],
                                            void *data) {
    (void)params;
    (void)data;

    // Register a device
    DeviceInfo device = {.device_type = DEVICE_TYPE_DISPLAY,
                         .name = "Graphics Card"};
    uint64_t device_id = register_device(&device);

    // Query by specific ID
    DeviceInfo results[10];
    uint32_t count = query_devices(QUERY_BY_ID, DEVICE_TYPE_UNKNOWN, device_id,
                                   results, 10);
...
static MunitResult test_query_devices_children(const MunitParameter params[],
                                               void *data) {
    (void)params;
    (void)data;

    // Create parent-child hierarchy
    DeviceInfo parent = {.device_type = DEVICE_TYPE_PCI,
                         .parent_id = 0,
                         .name = "PCI Bridge"};
    DeviceInfo child1 = {.device_type = DEVICE_TYPE_STORAGE,
                         .name = "Storage Child"};
    DeviceInfo child2 = {.device_type = DEVICE_TYPE_NETWORK,
                         .name = "Network Child"};
    ...
    DeviceInfo results[10];
    uint32_t count = query_devices(QUERY_CHILDREN, DEVICE_TYPE_UNKNOWN,
                                   parent_id, results, 10);
...
static MunitResult
test_query_devices_buffer_limit(const MunitParameter params[], void *data) {
    (void)params;
    (void)data;

    // Register 5 devices
    for (int i = 0; i < 5; i++) {
        DeviceInfo device = {.device_type = DEVICE_TYPE_UNKNOWN,
                             .name = "Test Device"};
    ...
    uint32_t count =
            query_devices(QUERY_ALL, DEVICE_TYPE_UNKNOWN, 0, results, 3);
...
static MunitTest test_suite_tests[] = {
        // Device registration tests
        {(char *)"/devman/register_device_basic", test_register_device_basic,
         setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/register_device_multiple",
         test_register_device_multiple, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
        {(char *)"/devman/register_device_max_capacity",
         test_register_device_max_capacity, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
        {(char *)"/devman/register_device_null_info",
         test_register_device_null_info, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},

        // Device unregistration tests
        {(char *)"/devman/unregister_device_basic",
         test_unregister_device_basic, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
        {(char *)"/devman/unregister_device_nonexistent",
         test_unregister_device_nonexistent, setup, NULL,
         MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/unregister_device_with_gaps",
         test_unregister_device_with_gaps, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},

        // Device query tests
        {(char *)"/devman/query_devices_all", test_query_devices_all, setup,
         NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/query_devices_by_type", test_query_devices_by_type,
         setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/query_devices_by_id", test_query_devices_by_id, setup,
         NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/query_devices_children", test_query_devices_children,
         setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {(char *)"/devman/query_devices_buffer_limit",
         test_query_devices_buffer_limit, setup, NULL, MUNIT_TEST_OPTION_NONE,
         NULL},
