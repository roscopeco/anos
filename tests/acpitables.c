...
static MunitResult test_map_bad_checksum_r0(const MunitParameter params[], void *param) {
...
static MunitTest test_suite_tests[] = {
    { (char*) "/acpitables/map_null", test_map_null, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/acpitables/bad_checksum_r0", test_map_bad_checksum_r0, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL },
