...
static E820h_MemMap *create_mem_map(int num_entries) {
  E820h_MemMap *map =
      malloc(sizeof(E820h_MemMap) + sizeof(E820h_MemMapEntry) * num_entries);
...
static MunitTest test_suite_tests[] = {
    ...
    {(char *)"/pmm/palloc/init_invalid", test_init_all_invalid, setup, teardown,
     MUNIT_TEST_OPTION_NONE, NULL},
    ...
    {(char *)"/pmm/palloc/init_persistent", test_init_all_persistent, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_unknown", test_init_all_unknown, setup, teardown,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_illegal", test_init_all_illegal, setup, teardown,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_zero_length", test_init_zero_length, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_too_small", test_init_too_small, setup, teardown,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_one_avail", test_init_one_available, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_unaligned_zero", test_init_unaligned_zero, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_unaligned_one", test_init_unaligned_one, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    ...
    {(char *)"/pmm/palloc/init_two_regions", test_init_two_regions, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_two_big_regions", test_init_two_large_regions,
     setup, teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/init_two_split_regions",
     test_init_two_noncontig_regions, setup, teardown, MUNIT_TEST_OPTION_NONE,
     NULL},
    ...
    {(char *)"/pmm/palloc/alloc_two_pages", test_alloc_two_pages, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/palloc/alloc_from_two_blocks", test_alloc_two_blocks, setup,
     teardown, MUNIT_TEST_OPTION_NONE, NULL},
