...
static MunitTest test_suite_tests[] = {
    ...
    {(char *)"/pmm/bitmap/set_bit_one", test_set_bit_one, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/set_bit_one_already", test_set_bit_one_zero_already,
     setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/set_two_bits", test_set_two_bits, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/set_1b_2nd_word", test_set_one_bit_second_word, setup,
     NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/set_bit_boundary", test_set_bit_boundary, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},

    {(char *)"/pmm/bitmap/clr_bit_zero", test_clear_bit_zero, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/clr_bit_zero_already", test_clear_bit_zero_already,
     setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/clr_bit_one", test_clear_bit_one, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/clr_bit_one_already", test_clear_bit_one_zero_already,
     setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
    ...
    {(char *)"/pmm/bitmap/flp_bit_one", test_flip_bit_one, setup, NULL,
     MUNIT_TEST_OPTION_NONE, NULL},
    {(char *)"/pmm/bitmap/flp_bit_one_already", test_flip_bit_one_zero_already,
     setup, NULL, MUNIT_TEST_OPTION_NONE, NULL},
