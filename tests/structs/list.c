...
static MunitResult test_insert_node_into_self(const MunitParameter params[], void *param) {
    // This should be a no-op, or it would create a circular list, which this lib doesn't support
    //
    ...
    // If next was previously non-null, should still be the same after (so again, no-op).
...
static bool always_true(ListNode *candidate) {
    return true;
}
...
static bool match_none(ListNode *candidate) {
    return false;
}
...
static MunitTest test_suite_tests[] = {
    { (char*) "/structs/list/insert_null_into_null", test_insert_null_into_null, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/insert_into_null", test_insert_into_null, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/insert_null_into_list", test_insert_null_into_list, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/insert_node_into_self", test_insert_node_into_self, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/insert_node_into_list", test_insert_node_into_list, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/insert_node_into_middle", test_insert_node_into_middle, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },

    { (char*) "/structs/list/add_null_to_null", test_add_null_to_null, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/add_node_to_null", test_add_node_to_null, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/add_null_to_list_one", test_add_null_to_list_one, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/add_null_to_list_multi", test_add_null_to_list_multi, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/add_node_to_list_one", test_add_node_to_list_one, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    { (char*) "/structs/list/add_node_to_list_multi", test_add_node_to_list_multi, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
    ...
    { (char*) "/structs/list/find_match_middle", test_find_match_middle, setup, teardown, MUNIT_TEST_OPTION_NONE, NULL },
