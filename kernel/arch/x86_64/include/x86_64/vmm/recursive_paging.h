...
static constexpr uintptr_t TABLE_BIT_MASK = 0x0000fffffffff000;

// Mask to remove the offset (bottom 12 bits) from an address
static constexpr uintptr_t OFFSET_MASK = 0xfffffffffffff000;

// Amount to shift a L1 index left when building
static constexpr uintptr_t L1_LSHIFT = 39;

// Amount to shift a L2 index left when building
static constexpr uintptr_t L2_LSHIFT = 30;

// Amount to shift a L3 index left when building
static constexpr uintptr_t L3_LSHIFT = 21;

// Amount to shift a L4 index left when building
static constexpr uintptr_t L4_LSHIFT = 12;
...
static constexpr uintptr_t L1_RSHIFT = 12;

// Amount to shift a vaddr right when extracting L2
// 3 more than you'd expect, we shift back by 3 to
// fix up the offset to a direct address.
static constexpr uintptr_t L2_RSHIFT = 21;

// Amount to shift a vaddr right when extracting L3
// 3 more than you'd expect, we shift back by 3 to
// fix up the offset to a direct address.
static constexpr uintptr_t L3_RSHIFT = 30;

// Amount to shift a vaddr right when extracting L4
// 3 more than you'd expect, we shift back by 3 to
// fix up the offset to a direct address.
static constexpr uintptr_t L4_RSHIFT = 39;

// Index of recursive mapping entry in PML4
// `0xffff800000000000`-> `0xffff807fffffffff` : 512GB Recursive mapping area when @ PML4[256]
static constexpr uintptr_t RECURSIVE_ENTRY_MAIN = 256;

// `0xffff808000000000`-> `0xffff80ffffffffff` : 512GB Recursive mapping area when @ PML4[257]
static constexpr uintptr_t RECURSIVE_ENTRY_OTHER = 257;

// MAIN is the primary recursive entry that will be used by default...
static constexpr uintptr_t RECURSIVE_ENTRY = RECURSIVE_ENTRY_MAIN;

static constexpr uintptr_t KERNEL_BEGIN_ENTRY = RECURSIVE_ENTRY + 2;

// Internal stuff...
static constexpr uintptr_t LVL_MASK = 0x1ff; // Mask to apply to a table index
static constexpr uintptr_t OFS_MASK = 0xfff; // Mask to apply to a page offset
...
//
static constexpr uintptr_t RECURSIVE_L1 = RECURSIVE_ENTRY << L1_LSHIFT;
static constexpr uintptr_t RECURSIVE_L2 = RECURSIVE_ENTRY << L2_LSHIFT;
static constexpr uintptr_t RECURSIVE_L3 = RECURSIVE_ENTRY << L3_LSHIFT;
static constexpr uintptr_t RECURSIVE_L4 = RECURSIVE_ENTRY << L4_LSHIFT;
 ...
 */
static inline uint64_t *vmm_virt_to_pte(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline PageTable *vmm_virt_to_pt(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline uint64_t *vmm_virt_to_pde(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline PageTable *vmm_virt_to_pd(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline uint64_t *vmm_virt_to_pdpte(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline PageTable *vmm_virt_to_pdpt(const uintptr_t virt_addr) {
 ...
 * (specified by `RECURSIVE_ENTRY`).
 */
static inline uint64_t *vmm_virt_to_pml4e(const uintptr_t virt_addr) {
 ...
 */
static inline PageTable *vmm_virt_to_pml4(const uintptr_t virt_addr) {
