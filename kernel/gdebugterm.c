...
bool debugterm_reinit(void volatile *_fb, const uint16_t phys_width, const uint16_t phys_height) {
    fb = _fb;
...
static inline uint16_t scroll() {
    ...
    constexpr uint64_t fill64 = (uint64_t)(' ' | (0x08 << 8)) * 0x0001000100010001ULL; // Repeat pattern
