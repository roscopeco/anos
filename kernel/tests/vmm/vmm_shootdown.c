...
bool vmm_map_page_containing_in(const uint64_t *pml4, const uintptr_t v,
                                const uintptr_t p, const uintptr_t f) {
...
bool vmm_map_pages_containing_in(const uint64_t *pml4, const uintptr_t v,
                                 const uintptr_t p, const uintptr_t f,
                                 const size_t n) {
    mock_map_called = true;
    last_virt_addr = v;
...
uintptr_t vmm_unmap_page_in(const uint64_t *pml4, const uintptr_t v) {
...
uintptr_t vmm_unmap_pages_in(const uint64_t *pml4, const uintptr_t v,
                             const size_t n) {
    mock_unmap_called = true;
    last_virt_addr = v;
    last_page_count = n;
...
uintptr_t vmm_virt_to_phys(const uintptr_t virt) { return virt ^ 0x12340000; }
