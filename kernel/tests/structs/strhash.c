...
static MunitResult test_str_hash_djb2_empty(const MunitParameter params[], void *user_data) {
...
*/
static MunitResult test_str_hash_djb2_normal(const MunitParameter params[], void *user_data) {
...
/* When max_len is less than the string length only the first max_len characters are processed.
   For "hello" with max_len == 3, only "hel" is hashed:
     ...
     - 'l': 5863442*33 + 108 = 193493694
*/
static MunitResult test_str_hash_djb2_max_len(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"hello";
...
static MunitResult test_str_hash_djb2_zero_max_len(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"hello";
...
static MunitResult test_str_hash_djb2_null(const MunitParameter params[], void *user_data) {
...
static MunitResult test_str_hash_sdbm_empty(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"";
...
static MunitResult test_str_hash_sdbm_zero_max_len(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"hello";
...
*/
static MunitResult test_str_hash_sdbm_partial(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"hello";
...
*/
static MunitResult test_str_hash_sdbm_full_vs_strlen(const MunitParameter params[], void *user_data) {
    unsigned char *str = (unsigned char *)"hello";
...
/* Null is the same as an empty string */
static MunitResult test_str_hash_sdbm_null(const MunitParameter params[], void *user_data) {
...
static MunitTest test_suite_tests[] = {
        {"/djb2/empty", test_str_hash_djb2_empty, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/djb2/normal", test_str_hash_djb2_normal, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/djb2/max_len", test_str_hash_djb2_max_len, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/djb2/zero_max", test_str_hash_djb2_zero_max_len, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/djb2/null", test_str_hash_djb2_null, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/sdbm/empty", test_str_hash_sdbm_empty, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/sdbm/zero_max", test_str_hash_sdbm_zero_max_len, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/sdbm/partial", test_str_hash_sdbm_partial, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/sdbm/full", test_str_hash_sdbm_full_vs_strlen, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {"/sdbm/null", test_str_hash_sdbm_null, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL},
        {NULL, NULL, NULL, NULL, MUNIT_TEST_OPTION_NONE, NULL}};

static const MunitSuite test_suite = {"/structs/strhash", test_suite_tests, NULL, 1, MUNIT_SUITE_OPTION_NONE};
