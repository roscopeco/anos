/*
 * stage3 - Font for graphical debug terminal
 * anos - An Operating System
 *
 * Copyright (c) 2025 Ross Bamford
 * 
 * I stole this font from Limine, which in turn stole it from
 * someplace else (see comment on the `gdebugterm_font` below).
 */

#ifndef __ANOS_KERNEL_GDEBUGTERM_FONT_H
#define __ANOS_KERNEL_GDEBUGTERM_FONT_H

#include <stdint.h>

// clang-format off

static const uint8_t gdebugterm_font_width = 8;
static const uint8_t gdebugterm_font_height = 16;
...
static const uint8_t gdebugterm_font[] = {
...
#endif //__ANOS_KERNEL_GDEBUGTERM_FONT_H
