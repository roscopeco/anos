...
static_assert(sizeof(AnosRAMFSHeader) == 32, "Size of AnosRAMFSHeader is not 32 bytes");
static_assert(sizeof(AnosRAMFSFileHeader) == 32, "Size of AnosRAMFSFileHeader is not 32 bytes");
